            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">音乐展示</span>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  yinyueList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../yinyue/detail.jsp?id='+item.id)">
                                            <img :src="item.yinyuePhoto?item.yinyuePhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.yinyueName}}</p>
                                            <p style="color: red;" v-if="item.yinyueNewMoney">{{item.yinyueNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../yinyue/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">舞蹈展示</span>
                        <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                    </div>
                    <span class="ng-inmod-thebor" aos="fade-up"></span>
                </div>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  wudaoList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../wudao/detail.jsp?id='+item.id)">
                                            <img :src="item.wudaoPhoto?item.wudaoPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.wudaoName}}</p>
                                            <p style="color: red;" v-if="item.wudaoNewMoney">{{item.wudaoNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../wudao/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`yinyue/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 1
        }, function (res) {
            vue.yinyueList = res.data.list;
        });
        http.request(`wudao/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 1
        }, function (res) {
            vue.wudaoList = res.data.list;
        });
    });
</script>
