          ...
          <input type="radio" name="sections" id="option1" checked="checked">
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">用户性别:</span>
                        <div class="layui-input-inline">
...
<!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuIdNumber" id="yonghuIdNumber"  lay-verify="identity|required"   placeholder="用户身份证号" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
  <!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuPhone" id="yonghuPhone"  lay-verify="phone|required"   placeholder="用户手机号" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
