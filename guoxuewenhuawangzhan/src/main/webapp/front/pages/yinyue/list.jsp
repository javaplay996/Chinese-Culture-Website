                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../yinyue/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../yinyue/detail.jsp?id='+item.id)"><span>{{item.yinyueName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 yinyueContent 字段去除无用字符 如果字段长度大于60  就截取到60
            yinyueContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (jquery('#yinyueName').val() != null && jquery('#yinyueName').val() != "" && jquery('#yinyueName').val() != "null" ) {
                param['yinyueName'] = jquery('#yinyueName').val();
                            ...
                            // 获取列表数据
            http.request('yinyue/list', 'get', param, function(res) {
