	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yinyueName" id="yinyueName" lay-verify="required" placeholder="音乐名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="yinyuePhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="yinyuePhoto" name="yinyuePhoto"/>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`yinyue/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#yinyuePhotoImg").attr("src", data.data.yinyuePhoto);
                });
