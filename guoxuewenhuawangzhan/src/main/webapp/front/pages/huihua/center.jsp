	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="huihuaName" id="huihuaName" lay-verify="required" placeholder="绘画名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="huihuaPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="huihuaPhoto" name="huihuaPhoto"/>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`huihua/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#huihuaPhotoImg").attr("src", data.data.huihuaPhoto);
                });
