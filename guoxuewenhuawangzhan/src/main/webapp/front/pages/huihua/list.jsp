            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">绘画展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="huihuaName" id="huihuaName" placeholder="绘画名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <div class="article-list">
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../huihua/detail.jsp?id='+item.id">
                                        <img width="180" class="fl" :src="item.huihuaPhoto" />
                                        <h5>{{item.huihuaName}}</h5>
                                        <p class="time-sour">
                                            <span>发布时间：{{item.insertTime}} </span>
                                        </p>
                                        <p class="reamk">{{item.huihuaContent|huihuaContent}}...</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 huihuaContent 字段去除无用字符 如果字段长度大于60  就截取到60
            huihuaContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#huihuaName').val() != null && jquery('#huihuaName').val() != "" && jquery('#huihuaName').val() != "null" ) {
                param['huihuaName'] = jquery('#huihuaName').val();
            }
                            // 获取列表数据
            http.request('huihua/list', 'get', param, function(res) {
