	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="wudaoName" id="wudaoName" lay-verify="required" placeholder="舞蹈名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="wudaoPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="wudaoPhoto" name="wudaoPhoto"/>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`wudao/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#wudaoPhotoImg").attr("src", data.data.wudaoPhoto);
                });
