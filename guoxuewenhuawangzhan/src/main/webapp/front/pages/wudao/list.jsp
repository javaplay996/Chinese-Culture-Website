                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../wudao/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../wudao/detail.jsp?id='+item.id)"><span>{{item.wudaoName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 wudaoContent 字段去除无用字符 如果字段长度大于60  就截取到60
            wudaoContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (jquery('#wudaoName').val() != null && jquery('#wudaoName').val() != "" && jquery('#wudaoName').val() != "null" ) {
                param['wudaoName'] = jquery('#wudaoName').val();
                            ...
                            // 获取列表数据
            http.request('wudao/list', 'get', param, function(res) {
