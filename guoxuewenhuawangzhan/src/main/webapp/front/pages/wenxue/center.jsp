	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="wenxueName" id="wenxueName" lay-verify="required" placeholder="文学名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="wenxuePhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="wenxuePhoto" name="wenxuePhoto"/>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`wenxue/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#wenxuePhotoImg").attr("src", data.data.wenxuePhoto);
                });
