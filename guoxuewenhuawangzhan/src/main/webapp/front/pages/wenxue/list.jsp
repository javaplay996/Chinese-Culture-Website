            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">文学展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="wenxueName" id="wenxueName" placeholder="文学名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <div class="article-list">
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../wenxue/detail.jsp?id='+item.id">
                                        <img width="180" class="fl" :src="item.wenxuePhoto" />
                                        <h5>{{item.wenxueName}}</h5>
                                        <p class="time-sour">
                                            <span>发布时间：{{item.insertTime}} </span>
                                        </p>
                                        <p class="reamk">{{item.wenxueContent|wenxueContent}}...</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 wenxueContent 字段去除无用字符 如果字段长度大于60  就截取到60
            wenxueContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#wenxueName').val() != null && jquery('#wenxueName').val() != "" && jquery('#wenxueName').val() != "null" ) {
                param['wenxueName'] = jquery('#wenxueName').val();
            }
                            // 获取列表数据
            http.request('wenxue/list', 'get', param, function(res) {
