...
var centerMenu = [
    ...
    ,{
        name: '舞蹈收藏',
        url: '../wudaoCollection/list.jsp'
    }
    ,{
        name: '音乐收藏',
        url: '../yinyueCollection/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '绘画',
        url: './pages/huihua/list.jsp'
    },
    {
        name: '文学',
        url: './pages/wenxue/list.jsp'
    },
    {
        name: '舞蹈',
        url: './pages/wudao/list.jsp'
    },
    {
        name: '音乐',
        url: './pages/yinyue/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/guoxuewenhuawangzhan/index.jsp";
